...
var mapStateToProps = function mapStateToProps(_imState, _ref) {
  var id = _ref.id;
  return {
...
var options = function options(jPlayerOptions) {
  initialState = initialState.merge(_constants.defaultStatus).merge(_constants.defaultOptions).merge(jPlayerOptions);
};
...
var _screenFullContainer = __webpack_require__(52);

var _screenFullContainer2 = _interopRequireDefault(_screenFullContainer);

var _errorLoggerContainer = __webpack_require__(54);

var _errorLoggerContainer2 = _interopRequireDefault(_errorLoggerContainer);

var _timeDisplayContainer = __webpack_require__(55);
...
var _volumeBarContainer = __webpack_require__(68);
...
var _downloadContainer = __webpack_require__(69);

var _downloadContainer2 = _interopRequireDefault(_downloadContainer);

var _durationContainer = __webpack_require__(70);
...
var _browserUnsupportedContainer = __webpack_require__(72);
...
var clearMedia = function clearMedia() {
  return (0, _immutable.fromJS)(_extends({}, _constants.defaultStatus, {
...
var setMedia = function setMedia(_, _ref) {
  ...
  return (0, _immutable.fromJS)(_extends({}, clearMedia(), {
    mediaSettings: {
      formats: formats,
      video: video,
...
var setOption = function setOption(jPlayer, _ref7) {
  ...
  switch (key) {
    ...
    default:
      return (0, _immutable.fromJS)(_defineProperty({}, key, value));
  }
};
...
var focusOnFirstKeyEnabledPlayer = function focusOnFirstKeyEnabledPlayer(state) {
  var newState = state.toJS();
  var firstKeyEnabledPlayer = Object.keys(newState).filter(function (key) {
    return newState[key].keyEnabled;
  }).shift();

  if (newState[firstKeyEnabledPlayer] !== undefined) {
    var focusedPlayer = _extends({}, newState[firstKeyEnabledPlayer], {
      focused: true
    });

    return (0, _immutable.fromJS)(_extends({}, newState, _defineProperty({}, firstKeyEnabledPlayer, focusedPlayer)));
  }

  return (0, _immutable.fromJS)(newState);
};

var updateJPlayer = function updateJPlayer(stateIm, action, fn) {
  var state = stateIm.toJS();
  ...
  return (0, _immutable.fromJS)(_extends({}, newState, _defineProperty({}, action.id, _extends({}, jPlayer, value))));
};

var reducer = function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _initializeOptions.getInitialState)();
...
var mapStateToProps = function mapStateToProps(_imState, _ref) {
  ...
  return {
    ...
    otherJPlayerIds: Object.keys(_imState.get('jPlayers').toJS()).filter(function (key) {
      return key !== id;
    })
  };
};
...
var mapStateToProps = function mapStateToProps(_imState, ownProps) {
  var id = ownProps.id,
  ...
  return {
    media: _imState.get('jPlayers').toJS()[id].media,
    fullScreen: _imState.get('jPlayers').toJS()[id].fullScreen,
    paused: _imState.get('jPlayers').toJS()[id].paused,
    startGuiFadeOut: _imState.get('jPlayers').toJS()[id].startGuiFadeOut,
    ...
    id: id,
    children: children,
    className: (0, _states2.default)(_imState.get('jPlayers').toJS()[id], ownProps.states, className)
  };
};
...
exports.default = (0, _recompose.compose)((0, _recompose.withContext)({ id: _propTypes2.default.string }, function (_ref) {
  var id = _ref.id;
  return { id: id };
...
var mergeProps = function mergeProps(stateProps, _ref2, _ref3) {
  var dispatch = _ref2.dispatch;
  var keyBindings = _ref3.keyBindings,
      id = _ref3.id;
  return {
...
var _screenfull = __webpack_require__(53);
...
var _animation = __webpack_require__(57);
...
var mapStateToProps = function mapStateToProps(_imState, _ref) {
  var id = _ref.id;
  return {
    title: (0, _reactJplayerUtils.formatArtistAndTitle)(_imState.get('jPlayers').toJS()[id].media.artist, _imState.get('jPlayers').toJS()[id].media.title)
  };
};
